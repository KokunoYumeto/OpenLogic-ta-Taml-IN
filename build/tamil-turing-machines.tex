...
% Keep warnings for severe line defects while tolerating the moderate ragged-footnote spacing seen in this reader.
\hbadness=6000
\input{../translation/tamil-config.sty}
\input{../translation/tamil-pdf-math.sty}
\tagtrue{novice,math,compsci,FOL,TMs,lambda,prvTrue,prvFalse,prvEx,prvAll}
...
\Crefname{cor}{தொடர்விளைவு}{தொடர்விளைவுகள்}
\AtBeginEnvironment{align*}{\fontsize{9}{12}\selectfont}
\AtBeginEnvironment{eqnarray*}{\fontsize{9}{12}\selectfont}
\AtBeginEnvironment{cor}{\fontsize{9}{12}\selectfont}
\hypersetup{pdftitle={OpenLogic Tamil: Turing machines},pdfauthor={OpenLogic Tamil translation programme},pdfsubject={Machine translation; OLP-0252 through OLP-0273; 22 of 722 frozen source units}}
\begin{document}
\raggedright
\raggedbottom
\pagestyle{plain}
\chapter*{திறந்த தருக்கவியல்}
\noindent தமிழ் மொழிபெயர்ப்பு -- டியூரிங் பொறிகள்
...
\noindent இந்தப் பிரதியில் 722 உறையவைக்கப்பட்ட மூல அலகுகளில் 22
மொழிபெயர்க்கப்பட்டுள்ளன. டியூரிங் பொறிகளின் முறைசார் வரையறை,
அமைவுநிலைகள், ஒரும எண் குறிப்பிடல், பொறிகளை இணைத்தல், அனைத்தளாவிய
பொறி, நிற்றல் சிக்கல், தீர்மானச் சிக்கல், முடிவுறு மாதிரிகளின்
தீர்மானிக்கவியலாமை ஆகியவற்றைக் கொண்ட முழு டியூரிங் பொறிகள் பகுதி
இதில் உள்ளது. உறையவைக்கப்பட்ட மூலத்தில் காணப்பட்ட கணித அல்லது
விளக்கக் குறைபாடுகள் தணிக்கைப் பதிவில் வெளிப்படையாகப் பதியப்பட்டுள்ளன.

\clearpage
\tableofcontents*
\subfile{../translation/content/turing-machines/turing-machines.tex}
\end{document}
