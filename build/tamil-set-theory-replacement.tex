...
\fi
\setlrmarginsandblock{21mm}{21mm}{*}
  ...
  \IfNoValueTF{#1}{%
    ...
    \ifstrequal{#1}{sth}{%
      \ifstrequal{#2}{replacement}{%
        \cref{sth:replacement:#3:#4}%
      }{%
        \ifstrequal{#2}{card-arithmetic}{%
          கார்டினல் எண்கணிதப் பிரிவு%
        }{%
          \ifstrequal{#2}{story}{%
            திரள்-படிநிலைமுறைக் கருத்தாக்கப் பிரிவு%
          }{%
            \ifstrequal{#2}{spine}{%
...
\RenewDocumentCommand \crefrange { m m }{முன்னைய தொடர்புடைய அத்தியாயங்கள்}
...
\Crefname{axiom}{அடிகோள்}{அடிகோள்கள்}
\hypersetup{pdftitle={OpenLogic Tamil: Replacement and Reflection},pdfauthor={OpenLogic Tamil translation programme},pdfsubject={Machine translation; OLP-0565 through OLP-0573; 9 of 722 frozen source units}}
...
\noindent தமிழ் மொழிபெயர்ப்பு — மாற்றீடும் பிரதிபலிப்பும்
...
அலகுகளில் OLP-0565 முதல் OLP-0573 வரையிலான 9 அலகுகள் இடம்பெறுகின்றன.
மாற்றீட்டின் வலிமை, வெளிப்புற மற்றும் உள்ளார்ந்த நியாயப்படுத்தல்கள்,
அளவு-வரம்பு, முற்றுமுடிவிலி, பிரதிபலிப்பு, வலுக்குறைந்த பிரதிபலிப்பு,
முடிவுறு அடிகோளாக்கத்தன்மை ஆகியவை விவாதிக்கப்படுகின்றன.

\clearpage
\tableofcontents*
\subfile{../translation/content/set-theory/replacement/replacement.tex}
